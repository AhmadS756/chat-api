...
embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001", google_api_key="AIzaSyBiXuCBFZ8KQx-jqmWb4BwKDy372N0soPc")
vector_index = Chroma.from_texts(texts, embeddings).as_retriever(search_kwargs={"k": 5})
model = ChatGoogleGenerativeAI(model="gemini-1.0-pro", google_api_key="AIzaSyBiXuCBFZ8KQx-jqmWb4BwKDy372N0soPc",
